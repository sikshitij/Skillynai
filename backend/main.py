...
app.mount("/realtime_interview", StaticFiles(directory=os.path.join(BASE_DIR, "realtime_interview"), html=True), name="realtime")
app.mount("/rounds", StaticFiles(directory=os.path.join(BASE_DIR, "frontend", "rounds"), html=True), name="rounds")
